@extends('layouts.app')
@section('title', 'Tambah Aset Hardware')
@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h5 class="fw-700 mb-1">Tambah Aset Hardware</h5>
...
<div class="row g-4">
    <div class="col-md-8">
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="brand" class="form-control" value="{{ old('brand') }}" placeholder="Dell, HP, Lenovo...">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-500 small">Model</label>
                        <input type="text" name="model" class="form-control" value="{{ old('model') }}" placeholder="Latitude 5520...">
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="specifications" class="form-control" rows="3" placeholder="RAM, CPU, Storage, dll...">{{ old('specifications') }}</textarea>
                    </div>
                    <div class="col-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-md-6">
                        <label class="form-label fw-500 small">Vendor / Supplier</label>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="purchase_price" class="form-control" value="{{ old('purchase_price') }}" min="0">
                    </div>
                    <div class="col-md-6">
    ...
    <div class="col-md-4">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="mb-3">
                    <label class="form-label fw-500 small">Kondisi <span class="text-danger">*</span></label>
                    <select name="condition" class="form-select" required>
                        @foreach(['Baik','Kurang Baik','Rusak'] as $c)
                        <option value="{{ $c }}" {{ old('condition','Baik') == $c ? 'selected' : '' }}>{{ $c }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="mb-3">
                    <label class="form-label fw-500 small">Status <span class="text-danger">*</span></label>
                ...
                <div class="mb-3">
                    ...
                    <select name="location_id" id="locationSelect" class="form-select">
                        ...
                        <option value="{{ $loc->id }}" data-branch="{{ $loc->branch_id }}" {{ old('location_id') == $loc->id ? 'selected' : '' }}>{{ $loc->name }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <img id="photoPreview" src="" class="mt-3 rounded w-100 d-none" style="max-height:180px;object-fit:cover;">
            </div>
        </div>

        <div class="d-grid gap-2 mt-4">
            <button type="submit" class="btn btn-primary"><i class="bi bi-check-lg me-2"></i>Simpan Aset</button>
